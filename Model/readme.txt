...
Our team developed two Notebooks to address the following:
   
	1. Data Exploration and Visualization
	2. Models Training


We finally opted for an XGBoost model that we tuned with Bayesian Optimization, as well as the linear projections through time horizons.
...
We even made a few attempts at stacking, but it is not documented on the notebook.
